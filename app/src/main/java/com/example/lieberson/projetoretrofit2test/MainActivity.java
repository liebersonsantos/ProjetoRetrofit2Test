package com.example.lieberson.projetoretrofit2test;
...
import com.example.lieberson.projetoretrofit2test.service.RetrofitService;
import com.example.lieberson.projetoretrofit2test.service.ServiceGenerator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void retrofitConverter(String unidadeEnt, String valorEnt, String unidadeSai) {
        ...
        call.enqueue(new Callback<RespostaServidor>() {
            ...
            public void onResponse(Call<RespostaServidor> call, Response<RespostaServidor> response) {
                ...
                if (response.isSuccessful()){
                    ...
                    //verifica aqui se o corpo da resposta nao é nulo
